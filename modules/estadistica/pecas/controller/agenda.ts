...
const outputFile = './err-' + type + '.json';
...
async function auxiliar(a: any, t: any) {
    ...
    if (t.estado === 'asignado' && t.paciente && t.asistencia) {
        ...
        turno.Apellido = turno.Apellido.toString().replace('\'', '\'\'');
        ...
        let objectoEdad = turno.FechaNacimiento ? calcularEdad(t.paciente.fechaNacimiento) : null;

        turno.Edad = turno.fechaNacimiento ? objectoEdad.valor : null;
        turno.uniEdad = turno.fechaNacimiento ? objectoEdad.unidad : null;
        turno.CodRangoEdad = turno.fechaNacimiento ? objectoEdad.CodRangoEdad : null;
        turno.RangoEdad = turno.fechaNacimiento ? objectoEdad.RangoEdad : null;
        turno.Peso = null;
        turno.Talla = null;
        turno.TAS = null;
        turno.TAD = null;
