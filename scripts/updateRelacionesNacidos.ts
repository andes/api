                ...
                if (!unaRel.relacion && unaRel.referencia) {
                    ...
                    if (pacParentezco) {
                        ...
                        if (pacParentezco.relaciones?.length) {
                            ...
                            if (indexRelProg > -1) {
                                pacParentezco.relaciones[indexRelProg] = hijoRelacion as any;
                            } else {
                                pacParentezco.relaciones.push(hijoRelacion as any);
                            }
                        } else {
                            pacParentezco.relaciones = [hijoRelacion as any];
                        }
