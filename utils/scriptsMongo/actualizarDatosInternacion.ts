...
export async function actualizarDatosProcess(done) {
    ...
    const filtros = {
        //   fechaIngresoDesde: new Date('2019-02-05'),
        //   fechaIngresoHasta: new Date('2019-02-07'),
    };
    ...
    try {
        ...
        for (let internacion of internaciones) {
            ...
            Auth.audit(internacion, (userScheduler as any));    // 5c59d93a1fbdbd02808e6683
            await internacion.save();
            Auth.audit(camaInternacion, (userScheduler as any));     // 5bd851e40747782e00f306c7
