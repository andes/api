...
var libString = (function () {
    ...
    libString.preprocessInput = function (input) {
        return input.trim().replace(/[!@#$%^&*()_+-=]/, '').replace(/\s\s+/g, ' ');
    };
    libString.maxLargo = function (stringAMin, stringBMin) {
    ...
    libString.minLargo = function (stringAMin, stringBMin) {
        var longA = stringAMin.length;
        var longB = stringBMin.length;
        if (longA < longB) {
            return longA;
    ...
    libString.obtenerConsonante = function (stringA, max) {
    ...
    libString.esConsonante = function (c) {
    ...
    libString.toTitleCase = function (str) {
        return str.replace(/\w\S*/g, function (txt) { return txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase(); });
    };
    libString.getCleanedString = function (cadena) {
    ...
    libString.makePattern = function (search_string) {
        var accented = {
