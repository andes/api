...
export async function findUser(username) {
    const pAuth = AuthUsers.findOne({ usuario: username, activo: true });
    const pProfesional = Profesional.findOne({ documento: username, activo: true }, { matriculas: true, especialidad: true });
